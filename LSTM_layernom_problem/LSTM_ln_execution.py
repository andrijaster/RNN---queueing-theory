    ...
    for layers in steps_layers:
        ...
        for size in steps_size:
            ...
            model1 = LSTM_ln(input_size=in_size, output_size=out_size, lstm_size=size, num_layers=layers,
                             num_steps=num_unroll, keep_prob=0.8, batch_size=512, init_learning_rate=0.1,
                             learning_rate_decay=0.92, init_epoch=8, max_epoch=no_epoch, MODEL_DIR = directory, name = name1)
            model2 = LSTM_ln(input_size=in_size, output_size=out_size, lstm_size=size, num_layers=layers,
                             num_steps=num_unroll, keep_prob=1, batch_size=512, init_learning_rate=0.1,
                             learning_rate_decay=0.92, init_epoch=8, max_epoch=no_epoch, MODEL_DIR = directory, name = name2)
